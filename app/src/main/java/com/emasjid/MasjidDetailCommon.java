...
public class MasjidDetailCommon extends AppCompatActivity {

    RecyclerView fav_rec;
    LinearLayoutManager mLayoutManager;
    RelativeLayout bottom, rel_top_header;
    ...
    String userid, usertype, masjidid, masjidstatus = "1", status;

    Activity context = MasjidDetailCommon.this;
    ...
    public void openDialogBox(Activity context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("test2947230","         openned");
        openDialogBox(MasjidDetailCommon.this);
...
//        String idString = parameters.getString("id");
        ...
        if (action.equals("android.intent.action.VIEW")) {
            ...
            dataarr = GetXmlData.getXmlData(MasjidDetailCommon.this, "masjid_detail.xml");
...
//                ((ImageView) viewlist.get("folowicon")).setVisibility(View.VISIBLE);
//                ((ToggleButton) viewlist.get("toggle")).setVisibility(View.VISIBLE);
                ...
                if (usertype.equals("masjid")) {
//                    ((ToggleButton) viewlist.get("toggle")).setVisibility(View.GONE);
                    ((ImageView) viewlist.get("folowicon")).setVisibility(View.GONE);
...
//                    ((ToggleButton) viewlist.get("toggle")).setVisibility(View.VISIBLE);
            ...
            Log.e("getType", intent.getType() + "");
            Log.e("getClipData", intent.getClipData() + "id");
            ...
            mLayoutManager = new LinearLayoutManager(MasjidDetailCommon.this);
...
//                    }
    ...
    public void FollowDialo() {
        ...
        final Dialog dialog = new Dialog(MasjidDetailCommon.this);
    ...
    private void ChangeStatusFollow() {
        if (AppConstants.isNetworkAvailable(context)) {
            ...
            if (masjidstatus != null && masjidstatus.length() > 0) {
    ...
    private void PrepareData() {
        ...
        if (AppConstants.isNetworkAvailable(MasjidDetailCommon.this)) {
            Map<String, String> mapParams = new HashMap<String, String>();
            mapParams.put("id", shareid);

            RequestClass.requesttoserverList(MasjidDetailCommon.this, mapParams, "masjid_detail.php", new ServiceCallback() {
                @Override
                public void onSuccesss(ResData data) {
                    ...
                    if (data.data.result.equals(Response.RESPONSE_RESULT.success)) {
                        ...
                        adapter = new MasjidDetailAdapter(MasjidDetailCommon.this, data.data);
            ...
            Toast.makeText(MasjidDetailCommon.this, "Please check internet connection.", Toast.LENGTH_SHORT).show();
        }
    }
