package http.social_login.instagram;
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    PROFILE_PICTURE = data_obj.getString(TAG_PROFILE_PICTURE);

                    Log.e("LOG : PROFILE_PICTURE", data_obj.getString(TAG_PROFILE_PICTURE) + "");
